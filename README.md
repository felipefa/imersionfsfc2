...
This is the repo of an app that simulates a delivery tracking system, tracing routes on a map in realtime.

Made to study the use of Docker, Kubernetes, Apache Kafka, Elasticsearch, Kibana, Go, microservices with Nest.js, React with websockets and geolocation.
